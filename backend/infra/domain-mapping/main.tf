# Configuration
#
# The Cloud Run domain mapping is split out from the API foundation because it
...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "projects/counter/baseline/backend/api/domain-mapping" # 🎨 TEMPLATE EJECT: Update the prefix (!)
  }
